...
dist = DIST_RANGE_IN_DEG_KEY #dist range in deg.
dep = DEPTH_IN_KM_KEY #depth in km

ddist = DIST_INTERVAL_KEY #dist interval, be exactly divided by dist
ddep = DEPTH_INTERVAL_KEY #depth interval, be exactly divided by dep
